...
module.exports = {
  name: "np",
  description: "Muestra la cancion que esta actualmente en reproducción",
  execute(message) {
    ...
    if (song.duration > 0) nowPlaying.setFooter("Tiempo Restante: " + new Date(left * 1000).toISOString().substr(11, 8));
